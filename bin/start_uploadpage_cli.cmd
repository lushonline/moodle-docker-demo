...
IF "%1"=="" ( SET "MOODLE_UPLOAD_FILE=uploadpage.csv" ) ELSE ( SET "MOODLE_UPLOAD_FILE=%1" )
...
echo.
call bin\moodle-docker-compose exec webserver php admin/tool/uploadpage/cli/uploadpage.php --source=../../../../%MOODLE_UPLOAD_FILE% --categoryid=%MOODLE_UPLOAD_CATEGORYID% %OTHEROPTIONS%
echo.